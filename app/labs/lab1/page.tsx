...
export default function Lab1() {
    return (
        <div id="wd-lab1">
            <h2>Lab 1</h2>
            <h2>Madison Seal - Section 33211</h2>
            <h3>HTML Examples</h3>
            <div id="wd-h-tag">
                <h4>Heading Tags</h4>
                <p id="wd-p-1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-tostones">
                <li>Get the greenest plantains you can</li>
                    <li>Peel and slice the plantains</li>
                    <li>Fry in warm oil the first time</li>
                    <li>Flatten the plaintains</li>
                    <li>Fry in hot oil the second time</li>
        ...
        <div id="wd-images">
            ...
            <br />
            <img id="wd-teslabot" src="/images/teslabot.jpg" height="200px"></img>
            </div>
    ...
    <textarea id="wd-textarea">"At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
    ...
    placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis
    aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur
     a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat."</textarea>
...
<h4>Anchor tag</h4>
Please
<a href="PLACEHOLDER FOR GITHUB LINK" id="wd-github">click here</a>
